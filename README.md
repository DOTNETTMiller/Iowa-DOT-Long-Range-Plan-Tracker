...
A comprehensive web-based tracker for Iowa Department of Transportation's Long Range Transportation Plan through 2050.

## Features

### 📋 All Plan Items View
- **54 Total Items** tracked including:
  - 30 Strategies
  - 5 Key Actions
...
- **Advanced Filtering**:
  ...
  - Filter by category (Strategy, Key Action, Modal/System Plan, etc.)
...
The tracker organizes Long Range Plan items into the following categories:

- **Strategy** (30 items): High-level strategic approaches
- **Key Action** (5 items): Critical implementation actions
- **Modal/System Plan** (11 items): Specialized transportation plans
- **Project**: Major infrastructure initiatives
- **Corridor/Tool**: Planning tools and corridor designations
- **Tool**: Analysis and decision-making tools
